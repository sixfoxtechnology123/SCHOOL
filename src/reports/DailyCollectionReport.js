// pages/DailyCollectionReport.js
...
const DailyCollectionReport = () => {
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(`http://localhost:5000/api/reports/daily-collection`, {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-4">Daily Collection Summary</h2>
