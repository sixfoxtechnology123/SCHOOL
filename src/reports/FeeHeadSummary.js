...
const FeeHeadSummary = () => {
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/reports/fee-head-summary", {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-4">Fee Head-wise Summary</h2>
