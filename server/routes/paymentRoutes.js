...
router.get("/scholarship/:studentId/:academicSession", controller.getLatestPaymentFlags);
router.get("/used-months/:studentId/:academicSession", controller.getUsedMonths);
